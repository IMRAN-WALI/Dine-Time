...
const GuestPicker = ({ selectedNumber, setSelectedNumber }) => {
  ...
  return (
    <View className="flex flex-row items-center rounded-xl text-white text-base">
      <TouchableOpacity onPress={decrement} className="rounded">
        <Text className="text-white border border-[#f49b33] rounded-l-lg px-3">
          -
        </Text>
      </TouchableOpacity>
      <Text className="px-3 text-white bg-[#474747] border border-[#474747]">
        {selectedNumber}
      </Text>
      <TouchableOpacity onPress={increment} className="rounded">
        <Text className="text-white border border-[#f49b33] rounded-r-lg px-3">
          +
        </Text>
      </TouchableOpacity>
    </View>
